...
const writePrintWindowDocument = (printWindow: Window, html: string): void => {
  ...
  try {
    ...
    throw new Error("The HMO invoice could not be rendered. Please try again.")
  }
}
        ...
        <section class="invoice-sheet">
          ...
          <table>
            <thead>
              <tr>
                ...
                <th class="text-center" style="width: 100px;">TREATMENT DATE</th>
                <th>PT SERVICE RENDERED</th>
                <th class="text-center" style="width: 50px;">QTY</th>
                <th class="text-center" style="width: 100px;">LATERALITY</th>
                <th class="text-center" style="width: 110px;">BODY AREA</th>
                <th class="text-right" style="width: 110px;">UNIT PRICE</th>
                <th class="text-right" style="width: 110px;">UNIT TOTAL</th>
              </tr>
            </thead>
            <tbody>
              ${lineRows || `<tr><td class="text-center">1</td><td colspan="7">No services found.</td></tr>`}
            </tbody>
          </table>
          ...
          <div class="bottom">
            <section class="payment-box">
              <h3>HMO DETAILS</h3>
              <div><strong>Billing To:</strong> ${escapeHtml(invoice.hmoName || "N/A")}</div>
              <div><strong>HMO Type:</strong> ${escapeHtml(invoice.hmoTypeName || "N/A")}</div>
              <div><strong>Company Name:</strong> ${escapeHtml(invoice.hmoCompanyName || "N/A")}</div>
              <div><strong>LOA Approval No.:</strong> ${escapeHtml(invoice.hmoApprovalCode || "N/A")}</div>
              <div><strong>LOA Validity:</strong> ${escapeHtml(formatDate(invoice.hmoValidityStart))} - ${escapeHtml(formatDate(invoice.hmoValidityEnd))}</div>
            </section>
