...
<html>
  <head>
    ...
    <style>
      ...
      @page {
        /* Do not force A4/A5/Letter. Let the printer/browser paper size win. */
        size: auto;
        margin: 6mm;
      }
  ...
  table-layout: auto;
      ...
      @media print {
        ...
        .invoice-sheet {
          ...
          height: auto !important;
          margin: 0 !important;
          padding: clamp(2.5mm, 1.4vw, 5mm) !important;
        ...
        .logo {
          width: auto !important;
          max-width: min(26mm, 24vw) !important;
          max-height: clamp(48px) !important;
        ...
        .invoice-title {
          ...
          letter-spacing: clamp(0.02em, 0.4vw, 0.05em) !important;
        }

        .meta-grid {
          gap: 1px clamp(3px, 0.8vw, 5px) !important;
          min-width: 0 !important;
          max-width: min(70mm, 58%) !important;
          width: auto !important;
          margin-left: auto !important;
          font-size: clamp(12px) !important;
        ...
        .line {
          grid-template-columns: minmax(56px, 32%) minmax(0, 1fr) !important;
          gap: clamp(2px, 0.8vw, 4px) !important;
        }

        .divider {
          border-top: 2px solid var(--invoice-accent) !important;
          margin-top: clamp(3px, 1vw, 5px) !important;
          margin-bottom: clamp(2px, 0.8vw, 3px) !important;
        }
  ...
  table-layout: auto !important;
        ...
        th,
        td {
          padding: clamp(2px, 0.55vw, 4px) !important;
        ...
        tr.line-item-child.hierarchy-depth-2 td:nth-child(3) {
          padding-left: clamp(12px, 2.4vw, 30px) !important;
        }
        ...
        .profile-summary {
          grid-template-columns: minmax(52px, 16%) minmax(0, 1fr) !important;
        ...
        .profile-photo-fallback {
          ...
          height: clamp(45px, 12vw, 70px) !important;
        }
        ...
        .profile-section h2 {
          font-size: clamp(18px) !important;
        }
        ...
        .bottom {
          width: 100% !important;
          margin-top: clamp(12px) !important;
          display: grid !important;
          grid-template-columns: minmax(0, 1fr) minmax(0, 0.42fr) !important;
        ...
        .approval-card {
          ...
          min-width: 0 !important;
          padding: clamp(6px, 1.3vw, 9px) !important;
          border-radius: 0 !important;
        }
        ...
        .approval-name {
          font-size: clamp(7px, 1.1vw, 9px) !important;
        }
        ...
        .footer {
          ...
          padding: clamp(2px, 0.8vw, 3px) clamp(4px, 1vw, 6px) !important;
          font-size: clamp(6px, 0.9vw, 7.5px) !important;
      ...
      /* Narrow paper support: A5 portrait, half-letter, receipts, or user custom sizes. */
      @media print and (max-width: 160mm) {
        .invoice-heading {
          display: grid !important;
          grid-template-columns: auto minmax(2, 1fr) !important;
        }
        ...
        .line {
          grid-template-columns: minmax(54px, 36%) minmax(0, 1fr) !important;
        }
      ...
      <header class="invoice-top">
        ...
        <div class="invoice-title-block">
          <h1 class="invoice-title">
            <span>${escapeHtml(invoice.headerTitle || "Patient Billing Summary")}</span>
          </h1>
        </div>
      </header>
