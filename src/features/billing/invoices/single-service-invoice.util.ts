...
const writePrintWindowDocument = (printWindow: Window, html: string): void => {
  ...
  try {
    ...
    throw new Error("The single service invoice could not be rendered. Please try again.")
  }
}
...
export function renderSingleServiceInvoiceWindow(
  ...
  const title = options?.title?.trim() || "Single Service Invoice"
        ...
        <section class="invoice-sheet">
          ...
          <table>
            <thead>
              <tr>
                ...
                <th class="text-right" style="width: 132px;">UNIT TOTAL</th>
              </tr>
            </thead>
            <tbody>
          ...
          <div class="bottom">
            ...
            <section class="approval">
              ...
              <div class="name">${escapeHtml(invoice.approvedBy || "RENALDO B. CORDOVA, PTRP, UK-PT")}</div>
