...
const writePrintWindowDocument = (printWindow: Window, html: string): void => {
  ...
  try {
    ...
    throw new Error("The LGU invoice could not be rendered. Please try again.")
  }
}
        ...
        <section class="invoice-sheet">
          ...
          <table>
            <thead>
              <tr>
                ...
                <th class="text-center" style="width: 110px;">TREATMENT DATE</th>
                <th>PT SERVICE RENDERED</th>
                <th class="text-center" style="width: 120px;">SESSION SEQUENCE</th>
                <th class="text-right" style="width: 126px;">UNIT PRICE</th>
              </tr>
            </thead>
            <tbody>
              ${lineRows || `<tr><td class="text-center">1</td><td colspan="4">No services found.</td></tr>`}
            </tbody>
          </table>
          ...
          <div class="bottom">
            <section class="payment-box">
              <h3>LGU DETAILS</h3>
              <div><strong>Billing To:</strong> ${escapeHtml(invoice.lguProgramName || "N/A")}</div>
              <div><strong>Referral Form No.:</strong> ${escapeHtml(invoice.lguReferenceLabel || "N/A")}</div>
              <div><strong>Date Issued:</strong> ${escapeHtml(formatDate(invoice.lguDateIssued))}</div>
            </section>
