<template>
  ...
  >
    ...
    >
      ...
      <p class="mt-4 text-sm sm:text-base text-[rgb(var(--app-fg))]/70">
        {{ description }}
      </p>
      ...
      <div class="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
        <button
          ...
          class="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl px-4 py-2.5
                 ...
                 app-brand-gradient hover:opacity-95"
        >
        ...
        <RouterLink
          ...
          class="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl px-4 py-2.5
                 ...
                 border border-[rgb(var(--app-border))]
                 bg-[rgb(var(--app-bg))]
                 hover:bg-[rgba(var(--app-secondary),0.10)]
      ...
      <p class="mt-7 text-xs text-[rgb(var(--app-fg))]/55">
...
const title = computed(() => {
  ...
  if (errorCode.value === "oauth_state_invalid") return "Sign-in session could not be verified"
...
const description = computed(() => {
  ...
  if (errorCode.value === "oauth_state_invalid") return "The secure Google sign-in cookie was missing or did not match when Google returned to the system. Restart the backend in Public Vercel Website auth mode, then begin sign-in again."
